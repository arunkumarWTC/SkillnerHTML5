...
! function(e) {
        ...
        e("source", t).each(function() {
            ...
            return t ? (e.isArray(t) ? t = {
                ...
                "flash" != n.type && t.sources.push({
                    type: n.type,
                    src: t.src.replace(w, "." + n.suffix + "$2")
                })
            })), t) : {
                sources: i
            }
    ...
    e.fn.flowplayer = function(t, n) {
        return "string" == typeof t && (t = {
            ...
            var i, a, o = e(this).addClass("is-loading"),
            ...
            var b = m || {
                conf: r,
                currentSpeed: 1,
                volumeLevel: "undefined" == typeof r.volume ? 1 * f.volume : r.volume,
                video: {},
                disabled: !1,
                finished: !1,
                loading: !1,
                muted: "true" == f.muted || r.muted,
                paused: !1,
                playing: !1,
                ready: !1,
                splash: !1,
            ...
            b.conf = e.extend(b.conf, r), e.each(["bind", "one", "unbind"], function(e, t) {
                ...
                }), u.push(b), b.engine ? (r.splash ? b.unload() : b.load(), r.disabled && b.disable(), a.volume(b.volumeLevel), o.one("ready", n), void 0) : b.trigger("error", {
        ...
        e.extend(n, {
            ...
            inlineVideo: !d && !p && (!u || v >= 3),
            hlsDuration: !i.safari || s || d || l,
            seekable: !s && !l
        });
        try {
            var g = navigator.plugins["Shockwave Flash"],
                m = o ? new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version") : g.description;
        ...
        var l = {
            ...
            load: function(l) {
                ...
                if (flowplayer.support.video && u.prop("autoplay") && v(l.sources) ? u.one("timeupdate", p) : p(), is_absolute || s.rtmp || (c = e("<img/>").attr("src", c)[0].src), r) r.__play(c);
                else {
        ...
        e.each("pause,resume,seek,volume".split(","), function(e, t) {
            l[t] = function(e) {
                try {
                    ...
                    if ("undefined" == typeof r["__" + t]) return i.trigger("flashdisabled", [n]);
                    throw a
                }
            }
        });
        ...
        return n.bind("ready fullscreen fullscreen-exit", function(t) {
            ...
            if (n.conf.flashfit || /full/.test(t.type)) {
                var r, s, l = n.isFullscreen,
                    ...
                    f = l ? u ? screen.width : d.width() : o,
                    p = l ? u ? screen.height : d.height() : a,
                    v = 0,
                    g = 0,
                    m = c ? o : "",
                    h = c ? a : "";
                (n.conf.flashfit || "fullscreen" === t.type) && (r = n.video.width / n.video.height, s = n.video.height / n.video.width, h = Math.max(s * f), m = Math.max(r * p), h = h > p ? m * s : h, h = Math.min(Math.round(h), p), m = m > f ? h * r : m, m = Math.min(Math.round(m), f), g = Math.max(Math.round((p + g - h) / 2), 0), v = Math.max(Math.round((f + v - m) / 2), 0)), e("object", i).css({
                    width: m,
                    height: h,
                    marginTop: g,
                    marginLeft: v
        ...
        function r(o, r, s) {
            o.listeners && o.listeners.hasOwnProperty(i.data("fp-player_id")) || ((o.listeners || (o.listeners = {}))[i.data("fp-player_id")] = !0, r.bind("error", function(n) {
                try {
                    ...
                    a(e(n.target).attr("type")) && t.trigger("error", {
                        code: 4
                    })
                } catch (i) {}
            ...
            pick: function(e) {
                if (c.video) {
                    ...
                    for (var n = 0; n < e.length; n++)
                        if (a(e[n].type)) return e[n]
                }
            },
            load: function(n) {
                if (p.splash && !d) u = b(n).prependTo(i), c.inlineVideo || u.css({
                    position: "absolute",
                    top: "-9999em"
                }), f.length && u.append(f.attr("default", "")), p.loop && u.attr("loop", "loop"), d = u[0];
                else {
                    d = u[0];
                    var a = u.find("source");
    ...
    e.throttle = function(e, t) {
        ...
        return this.each(function() {
            var i, a, o, r, s, l, d, u, c = e(this),
                ...
                y = function(e, t) {
                    ...
                    return (!d || d >= e) && (n || p.stop(), v ? p.css("width", i) : p.animate(s ? {
                        height: i
                    } : {
                        width: i
                    }, t, "linear")), e
        ...
        t.bind("ready", function() {
            ...
            !e.seekable && l.seekable && w.max(n), 1 > n ? c.css("width", 100 * n + "%") : c.css({
                width: "100%"
            })
        }).bind("speed", function(e, t, n) {
        ...
        var F = n.css("backgroundColor"),
            _ = "none" != n.css("backgroundImage") || F && "rgba(0, 0, 0, 0)" != F && "transparent" != F;
        !_ || s.splash || s.autoplay || t.bind("ready stop", function() {
            n.addClass("is-poster").one("progress", function() {
                n.removeClass("is-poster")
            })
        }), !_ && t.forcedSplash && n.css("backgroundColor", "#555"), e(".fp-toggle, .fp-play", n).click(t.toggle), e.each(["mute", "fullscreen", "unload", "toppause", "uinext-bottom", "uipre", "uinext-full", "uinext", "uinext-full-center"], function(e, n) {
            i(n).click(function() {
            	if(n== 'uinext')
            		t['nextstep']()
            	else if(n== 'uipre')
    ...
    e(document).bind("keydown.fp", function(t) {
        ...
        if (n && o.keyboard && !n.disabled) {
            if (-1 != e.inArray(a, [63, 187, 191])) return x.toggleClass(C), !1;
            if (27 == a && x.hasClass(C)) return x.toggleClass(C), !1;
            if (!i && n.ready) {
    ...
    var T, S = e.browser.mozilla ? "moz" : "webkit",
        ...
        D = /(safari)[ \/]([\w.]+)/.exec(A) && !/(chrome)[ \/]([\w.]+)/.exec(A);
    e(document).bind(M ? "fullscreenchange" : S + "fullscreenchange", function(t) {
        ...
        if (t.conf.fullscreen) {
            ...
            t.isFullscreen = !1, t.fullscreen = function(r) {
                return t.disabled ? void 0 : (void 0 === r && (r = !t.isFullscreen), r && (i = a.scrollTop()), "webkit" != S && !D || "flash" != t.engine || (o.index = t.video.index, t.conf.rtmp && e.extend(o, {
                    pos: t.video.time,
                    play: t.playing
                })), E ? r ? M ? n[0].requestFullscreen() : (n[0][S + "RequestFullScreen"](Element.ALLOW_KEYBOARD_INPUT), !D || document.webkitCurrentFullScreenElement || document.mozFullScreenElement || n[0][S + "RequestFullScreen"]()) : M ? document.exitFullscreen() : document[S + "CancelFullScreen"]() : t.trigger(r ? F : _, [t]), t)
            };
            var r;
            n.bind("mousedown.fs", function() {
                ...
                if (o.index > 0) t.play(o.index), o.index = 0;
                else if (o.pos && !isNaN(o.pos)) {
                    var n = function() {
                        o.play || t.pause(), e.extend(o, {
                            pos: 0,
                            play: !1
                        })
                    };
        ...
        if (i().length) {
            s || (t.conf.playlist = [], i().each(function() {
                ...
                var i = e(n.target).closest(o.query),
                    a = Number(i.attr("data-index")); - 1 != a && t.play(a)
            });
            ...
            t.bind("load", function(i, o, s) {
                var l = a().removeClass(r),
                    ...
                    f = e('a[data-index="' + c + '"]', n).addClass(r),
    ...
    flowplayer(function(t, n) {
        ...
        t.cuepoints = t.conf.cuepoints || [], t.bind("progress", function(e, o, r) {
            ...
            a = r;
            for (var s, l = t.cuepoints || [], d = 0; d < l.length; d++) s = l[d], isNaN(s) || (s = {
                time: s
            }), s.time < 0 && (s.time = t.video.duration + s.time), s.index = d, Math.abs(s.time - r) < .125 * t.currentSpeed && (i(d), n.trigger("cuepoint", [t, s]))
                        ...
                        for (var a, o, s, l, d = 0, u = n.split("\n"), c = u.length, f = {}; c > d; d++)
                            if (o = r.exec(u[d])) {
                                ...
                                f = {
                                    ...
                                    time: f.startTime,
                                    subtitle: f
                                }, t.subtitles.push(f), t.cuepoints.push(l), t.cuepoints.push({
                                    time: f.endTime,
                                    subtitleEnd: a
    ...
    (flowplayer.support.touch || L) && flowplayer(function(t, n) {
        var i = /Android/.test(f) && !/Firefox/.test(f) && !/Opera/.test(f),
            a = /Silk/.test(f),
            o = i ? parseFloat(/Android\ (\d\.\d)/.exec(f)[1], 10) : 0;
        ...
        if (t.conf.embed !== !1) {
            var i = t.conf,
                ...
                r = e("<div/>", {
                    "class": "fp-embed-code"
                }).append("<label>Paste this HTML code on your site to embed.</label><textarea/>").appendTo(a),
                s = e("textarea", r);
            t.embedCode = function() {
                ...
                e.each(["origin", "analytics", "key", "rtmp"], function(e, t) {
                    ...
                    var a = n.src;
                    (!/^https?:/.test(n.src) && "flash" !== n.type || !i.rtmp) && (a = e("<img/>").attr("src", n.src)[0].src), l.append(e("<source/>", {
                        type: "video/" + n.type,
                        src: a
                    }))
                });
